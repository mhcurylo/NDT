(defproject ndt "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "ndt.core/on-figwheel-reload"}

                :compiler {:main ndt.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/ndt.js"
